...
class _RemoteDataSource implements RemoteDataSource {
  ...
  @override
  Future<CocktailDetailsResponse> getCocktailDetails(drinkId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'i': drinkId};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CocktailDetailsResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/lookup.php',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = CocktailDetailsResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<CocktailDetailsResponse> getRandomCocktail() async {
    const _extra = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CocktailDetailsResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/random.php',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = CocktailDetailsResponse.fromJson(_result.data!);
    return value;
  ...
  @override
  Future<CocktailResponse> searchCocktailsByName(name) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<CocktailResponse> searchCocktailsByIngredient(ingredient) async {
    const _extra = <String, dynamic>{};
